...
import { type SessionSummary, deleteSession, getSessions } from "@/api/openresponses-sessions"

const LIMIT = 20

interface UseOpenResponsesSessionHistoryOptions {
  activeSessionId: string
  onDeletedActiveSession: () => void
}

export function useOpenResponsesSessionHistory({
  activeSessionId,
  onDeletedActiveSession,
}: UseOpenResponsesSessionHistoryOptions) {
